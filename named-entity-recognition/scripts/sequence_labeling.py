...
from scripts.v1 import SCORES, _precision_recall_fscore_support
from scripts.v1 import classification_report as cr
from scripts.v1 import precision_recall_fscore_support as precision_recall_fscore_support_v1
from scripts.reporters import DictReporter, StringReporter
from scripts.scheme import Entities, Token
...
def precision_recall_fscore_support(y_true: List[List[str]],
    ...
    precision, recall, f_score, true_sum = _precision_recall_fscore_support(
        ...
        scheme=None,
        suffix=suffix,
        extract_tp_actual_correct=extract_tp_actual_correct_lenient
    )
...
def f1_score(y_true: List[List[str]], y_pred: List[List[str]],
    ...
    Args:
        ...
        mode : str, [None (default), `strict`].
            if ``None``, the score is compatible with lenient score Otherwise,
